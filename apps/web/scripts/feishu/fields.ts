...
export const PRIVATE_BASE_FIELD_NAMES = {
  content: {
    ...
    valueVerdict: BASE_FIELDS.content.valueVerdict,
    freshnessVerdict: BASE_FIELDS.content.freshnessVerdict,
    factualVerdict: BASE_FIELDS.content.factualVerdict,
    auditDecision: BASE_FIELDS.content.auditDecision,
    auditNote: BASE_FIELDS.content.auditNote,
    auditedAt: BASE_FIELDS.content.auditedAt,
    nextReviewAt: BASE_FIELDS.content.nextReviewAt,
