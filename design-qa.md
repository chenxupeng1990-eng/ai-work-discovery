...
- State: initial discovery page, featured sort, no query, all categories
...
- Copy: the selected headline, support copy, weekly feature title, CTA labels, search copy, categories, and result count are preserved.
...
- Search query, category selection, featured/latest sorting, Hero CTA route, keyboard interaction, desktop/mobile overflow, and card separation are covered by Playwright.
- Browser console and page error listeners reported no errors during search, category, and sorting interactions.
